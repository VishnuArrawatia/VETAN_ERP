-- VETAN ERP — NORMALIZED TABLE CREATION (Copy-paste into Supabase SQL Editor)
-- 
-- HOW TO RUN:
...
-- 4. Click "Run"
-- 5. Verify all tables created (check "Table" section in left panel)
--
-- SAFETY: This only CREATES new tables. It does NOT touch existing vetan_erp_store.
...
-- VERIFICATION: Run after COMMIT to confirm all tables created
SELECT table_name FROM information_schema.tables 
WHERE table_schema = 'public' AND table_name LIKE 'vetan_%' 
ORDER BY table_name;
